...
export const Auth = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <form className="text-white flex flex-col justify-center w-[450px] h-[300px] m-auto items-center mt-10 border-3 border-yellow-200 shadow-[7px_8px_15px_#000] hover:bg-blue-700" onSubmit={handleSubmit}>
